...
SELECT * FROM LOB_CERRADO_DETALLE WHERE Cer_Id IN (882073,882089,882341,856257)
SELECT * FROM LOB_CERRADO WHERE Cer_Id IN (882073,882089,882341,856257)


SELECT * FROM LOB_CERRADO_DETALLE WHERE TaxAmt IS NOT NULL